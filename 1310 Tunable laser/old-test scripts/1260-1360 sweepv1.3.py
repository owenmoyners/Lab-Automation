...
#Make windows for file path and file name
#Power meter readings to be more accurate/ new power meter device
#open and close pmmanager
...
''' SET PATH OF FILE'''
path = r"\\10.204.28.1\docs2\owen.moynihan\My Documents\Project work\Test programs\Python Files\Tuneable laser test\Results"

''' SET NAME OF FILE'''
file_name = '1260-1360 Sweep_intel_sample'  #AUTOMATICALLY SETS AS CSV FILE
...
with open(file_name + ".csv", 'w', newline='') as csvfile:
    ...
    fieldnames =['Wavelength (nm)', 'Power (W)'] #setting the row titles
