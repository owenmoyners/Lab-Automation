...
file_name = 'my file name' # do not specify file type (saves as csv)
...
if File == True:
    ...
    time.sleep(1)
    print(f"You will overwrite pervious {file} file")
...
with open(file_name + ".csv", 'w', newline='') as csvfile:
    ...
    thewriter.writerow({'Wavelength (nm)': f"Voltage = {V}V, LED power = {LED}, Etchant = {etchant}" })     
